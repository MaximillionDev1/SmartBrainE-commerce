...
let containerProdutos = document.querySelector(".products-grid")
...
const showAllProducts = () => {
    ...
    let filteredProducts = produtos.filter(prd => {
        ...
        let passedCategory = (currentCategory === "all" || prd.categoria == currentCategory)

        let passedResearch = prd.nome.toLowerCase().includes(searchtext.toLowerCase())

        return passedResearch && passedCategory
    })
    ...
    containerProdutos.innerHTML = htmlProducts;
}
